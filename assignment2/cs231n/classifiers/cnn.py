...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        aff_out1, aff_cache1 = affine_relu_forward(pool_out, W2, b2)
        scores, aff_cache2 = affine_forward(aff_out1, W3, b3)
        ...
        dataloss, softmax_grad = softmax_loss(scores, y)
        ...
        dout, grads['W3'], grads['b3'] = affine_backward(softmax_grad, aff_cache2)
        dout, grads['W2'], grads['b2'] = affine_relu_backward(dout, aff_cache1)
